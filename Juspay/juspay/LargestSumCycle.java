...
//        }
        ...
        int[]edge1 ={4, 4, 1, 4, 13, 0, 8, 8, 5, 8, 14, 9, 15, 11, -1, 10, 15, 22, 22, 22, 22, 22, 21};
        int[]edge2 ={4, 4, 1, 4, 13, 0, 8, 8, 5, 8, 14, 10, 15, 11, 0, 10, 15, 22, 22, 22, 22, 22, 21};
        System.out.println(largestSum(edge));
        System.out.println(largestSum(edge1));
        System.out.println(largestSum(edge2));
    }
}
